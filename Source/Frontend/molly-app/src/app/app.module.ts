...
import { EditViewColumnDescriptionDialogComponent } from './components/edit-view-column-description-dialog/edit-view-column-description-dialog.component';
...
@NgModule({
  declarations: [
    ...
    EditViewColumnDescriptionDialogComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
